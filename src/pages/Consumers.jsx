...
const Consumers = () => {
  return (
    <section id="consumers" className="w-full px-6 md:px-16 lg:px-24 xl:px-32 py-20 bg-[#f2f8fd] text-center font-Jakarta   ">
  ...
  <div className="flex flex-col items-center justify-center">
    <div className="flex gap-2 text-blue-500 font-bold text-2xl">
      <GoHorizontalRule />
      <GoHorizontalRule />
      <GoHorizontalRule />
    </div>
      ...
      <div className="py-16 px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg flex flex-col h-full">
            ...
            <button className="mt-auto border px-5 py-3 rounded-lg text-gray-700 hover:bg-gray-100 transition w-full">
              Learn More
            </button>
          </div>
