...
const HeroSection = () => {
  return (
    <section className="flex items-center justify-center text-center lg:flex-row flex-col px-6 bg-white pt-16 md:pt-20">
  ...
  Kobba & Co. –  
  <br />
  <span className="text-blue-600">Expert Legal Solutions <br></br> You Can Trust</span>
</h1>
